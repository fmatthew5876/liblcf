...
namespace rpg {
	...
	template <> struct ReflectStruct<Class> {
		using type_t = Class;
		static constexpr const auto& name = "Class";
	};
	// String
	...
	template <typename T, typename Visitor, EnableIfStruct<T,Class>* = nullptr>
	void ForEachMember(T&& s, const Visitor& v) {
		v(s, s.name, LCF_REFL_S(Class)(), LCF_REFL_M(Class, name)());
		v(s, s.two_weapon, LCF_REFL_S(Class)(), LCF_REFL_M(Class, two_weapon)());
		v(s, s.lock_equipment, LCF_REFL_S(Class)(), LCF_REFL_M(Class, lock_equipment)());
		v(s, s.auto_battle, LCF_REFL_S(Class)(), LCF_REFL_M(Class, auto_battle)());
		v(s, s.super_guard, LCF_REFL_S(Class)(), LCF_REFL_M(Class, super_guard)());
		v(s, s.parameters, LCF_REFL_S(Class)(), LCF_REFL_M(Class, parameters)());
		ForEachMember(s.parameters, v);
		v(s, s.exp_base, LCF_REFL_S(Class)(), LCF_REFL_M(Class, exp_base)());
		v(s, s.exp_inflation, LCF_REFL_S(Class)(), LCF_REFL_M(Class, exp_inflation)());
		v(s, s.exp_correction, LCF_REFL_S(Class)(), LCF_REFL_M(Class, exp_correction)());
		v(s, s.battler_animation, LCF_REFL_S(Class)(), LCF_REFL_M(Class, battler_animation)());
		v(s, s.skills, LCF_REFL_S(Class)(), LCF_REFL_M(Class, skills)());
		for (auto&& e: s.skills) {
			ForEachMember(e, v);
		}
		v(s, s.state_ranks, LCF_REFL_S(Class)(), LCF_REFL_M(Class, state_ranks)());
		v(s, s.attribute_ranks, LCF_REFL_S(Class)(), LCF_REFL_M(Class, attribute_ranks)());
		v(s, s.battle_commands, LCF_REFL_S(Class)(), LCF_REFL_M(Class, battle_commands)());
	}
