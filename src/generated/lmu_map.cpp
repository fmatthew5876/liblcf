...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, scroll_type, 0, 0),
	...
	LCF_STRUCT_TYPED_FIELD(std::vector<uint32_t>, generator_x, 1, 0),
	LCF_STRUCT_TYPED_FIELD(std::vector<uint32_t>, generator_y, 1, 0),
	LCF_STRUCT_TYPED_FIELD(std::vector<int16_t>, generator_tile_ids, 1, 0),
