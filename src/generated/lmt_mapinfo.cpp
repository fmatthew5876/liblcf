...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, music_type, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, background_type, 0, 0),
	LCF_STRUCT_TYPED_FIELD(std::string, background_name, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, teleport, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, escape, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, save, 0, 0),
