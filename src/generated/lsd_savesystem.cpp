...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, switches_size, 0, 0),
	LCF_STRUCT_TYPED_FIELD(std::vector<bool>, switches, 1, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, variables_size, 0, 0),
	LCF_STRUCT_TYPED_FIELD(std::vector<uint32_t>, variables, 1, 0),
	...
	LCF_STRUCT_TYPED_FIELD(RPG::Music, inn_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, current_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, before_vehicle_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, before_battle_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, stored_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, boat_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, ship_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, airship_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Music, gameover_music, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, cursor_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, decision_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, cancel_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, buzzer_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, battle_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, escape_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, enemy_attack_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, enemy_damaged_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, actor_damaged_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, dodge_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, enemy_death_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(RPG::Sound, item_se, 0, 0),
	LCF_STRUCT_TYPED_FIELD(uint8_t, transition_out, 0, 0),
	LCF_STRUCT_TYPED_FIELD(uint8_t, transition_in, 0, 0),
