...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, direction, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, sprite_direction, 0, 0),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, layer, 0, 0),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, remaining_ascent, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, remaining_descent, 0, 0),
	LCF_STRUCT_TYPED_FIELD(std::string, sprite2_name, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, sprite2_id, 0, 0),
