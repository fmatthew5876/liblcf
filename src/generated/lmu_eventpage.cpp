...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, character_direction, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, character_pattern, 0, 0),
	LCF_STRUCT_TYPED_FIELD(bool, translucent, 0, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, move_type, 0, 0),
	...
	LCF_STRUCT_SIZE_FIELD(RPG::EventCommand, event_commands, 0, 0),
